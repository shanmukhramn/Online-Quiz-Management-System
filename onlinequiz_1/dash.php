    ...
    <div class="container-fluid" id="nav-bar">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li <?php if (@$_GET['q'] == 1) echo ''; ?>><a href="dash.php?q=0"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
          <li <?php if (@$_GET['q'] == 2) echo ''; ?>><a href="dash.php?q=1"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;User</a></li>
          <li <?php if (@$_GET['q'] == 3) echo ''; ?>><a href="dash.php?q=2"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
          <li <?php if (@$_GET['q'] == 4) echo ''; ?>><a href="feedback.php"><span class="glyphicon glyphicon-text" aria-hidden="true"></span>&nbsp;Feedback</a></li>
          <li class="dropdown <?php if (@$_GET['q'] == 4 || @$_GET['q'] == 5) echo ''; ?>">
