...
ALTER TABLE quiz ADD COLUMN correct_answers INT(11) NOT NULL;

INSERT INTO `quiz` (`eid`, `title`, `correct_answers`, `wrong`, `total`, `time`, `intro`, `tag`, `date`) 
VALUES
('558920ff906b8', 'Linux: File Management', 2, 1, 2, 5, '', 'linux', '2015-06-23 09:03:59'),
